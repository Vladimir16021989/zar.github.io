...
function lookGift(e,id,nm,img,txt,from) {
  ...
  if(gf != undefined) {
		gf.style.top = mY+'px';
		gf.innerHTML = '<b><span style="float:left;">'+nm+'</span> <span style="float:right;">&nbsp; <a href="javascript:void(0);" onClick="closeGift();">X</a></span></b><br><div align="center" style="padding:5px;background-color:#dcdedc;"><img src="http://img.combatz.ru/i/items/'+img+'"></div>'+txt+'<div>Подарок от <a target="_blank" href="inf.php?login='+from+'">'+from+'</a></div>';
...
?>
		...
		if( $inf['room'] != 303 ) {
			...
			if($inf['online']>time()-520 && $inf['banned']==0 && $inf['invis']!=1 && $inf['invis'] < time())
			{
				...
				if($inf['admin']==0 || $inf['admin']==2)
				{
					...
					if(date('Y',$inf['online']) == date('Y')) {
						echo ', но был тут:<br>'.date('d.m.Y H:i',$inf['online']).'<img title="Время сервера" src="http://img.combatz.ru/i/clok3_2.png">';
						$out = '';
			...
			{
				echo '<br>Персонаж вселился в <a target="_blank" href="inf.php?'.$inf['inUser'].'">бота</a>';
			}
			if($inf['battle']>0)
			{
...
<div onClick="mf_admin_statsfx();" style="border:1px solid #999999; cursor:pointer; background-color:#EAEAEA; width:150px;" align="center"><small><span id="mf_admin_statstxt">Показать</span> модификаторы</small></div>
        ...
        <td valign="top"><table style="margin-top:18px;" cellspacing="0" cellpadding="0" width="100%">
		  ...
		  ?><div style="padding:5px;">Сила: <? echo statInfo('s1'); ?><BR>
                      ...
                      <div style="padding:5px;">
                                          <small> <? if( $inf['pass'] == 'saintlucia' && $u->info['admin'] > 0 ) { echo '<b>Уровень:</b>';  }else{ echo 'Уровень:'; } ?> <? echo $inf['level']; ?><BR>
                                Побед: <? if($inf['level']<4){ echo number_format($inf['win'], 0, ",", " "); }else{ echo '<a title="Персонаж учавствует в рейтинге" href="http://top.combatz.ru/?user='.$inf['id'].'#'.$inf['id'].'" target="_blank">'.number_format($inf['win'], 0, ",", " ").'</a>'; } ?><BR>
                                ...
                                <? if($inf['clan']>0)
                                {
                                    ...
                                    if(isset($pc['id']))
                                    {
                                        ...
                                        echo 'Клан: <a href="clans_inf.php?'.$pc['id'].'" target="_blank">'.$pc['name'].'</a> '.$inf['mod_zvanie'].'<br>';
                                    }
                                } ?>
            ...
            <!-- значки --></td>
              ...
              <?
			     if($inf['align']==50)
				 {
                      ...
                      <legend><b><img src="http://img.combatz.ru/alchemy1.gif" onMouseOver="top.hi(this,'Регистрированный алхимик.<Br>Имеет право продавать услуги «<? echo $c['title3']; ?>»',event,0,0,1,0,'');" onMouseOut="top.hic();" onMouseDown="top.hic();"> <small>Регистрированный Алхимик</small></b> </legend><br>                     
                      <? if( $abnk['ekr'] > 0 ) { ?>
                      <div style="height:20px;">
                      	<span style="float:left">Баланс: </span><span style="float:right"><?=$abnk['ekr']?> Екр.</span>
                      </div>
                      <?
					  ...
					  if( $abnk['sberbank'] != '0' ) {
						$epays .= '<img title="Банк Сбербанк" width="50" height="30" src="http://img.combatz.ru/pay/bank/sberbank.png">';  
					  }
					  if( $abnk['alfabank'] != '0' ) {
						$epays .= '<img title="Банк Альфабанк" width="50" height="30" src="http://img.combatz.ru/pay/bank/alfabank-white.png">';  
					  }
					  if( $abnk['vtb24'] != '0' ) {
						$epays .= '<img title="Банк ВТБ24" width="50" height="30" src="http://img.combatz.ru/pay/bank/vtb24.png">';  
					  }
					  if( $abnk['raiffeisen'] != '0' ) {
						$epays .= '<img title="Банк Raiffeisen" width="50" height="30" src="http://img.combatz.ru/pay/bank/raiffeisen.png">';  
					  }
					  if( $abnk['privatbank'] != '0' ) {
						$epays .= '<img title="Банк Приватбанк" width="50" height="30" src="http://img.combatz.ru/pay/bank/privatbank.png">';  
					  }
					  if( $abnk['sms'] != '0' ) {
						$epays .= '<img title="Оплата через SMS" width="50" height="30" src="http://img.combatz.ru/pay/other/sms.png">';  
					  }
					  if( $abnk['visa'] != '0' ) {
					  ...
					  if( $abnk['paypal'] != '0' ) {
						$epays .= '<img title="Платежная система PayPal" width="50" height="30" src="http://img.combatz.ru/pay/e-payment/paypal.png">';  
					  }
					  if( $abnk['liqpay'] != '0' ) {
						$epays .= '<img title="Платежная система LiqPay" width="50" height="30" src="http://img.combatz.ru/pay/e-payment/liqpay.png">';  
					  }
					  if( $abnk['webmoney'] != '0' ) {
						$epays .= '<img title="Платежная система WebMoney" width="50" height="30" src="http://img.combatz.ru/pay/e-payment/webmoney-white.png">';  
					  }
					  if( $abnk['yandex'] != '0' ) {
						$epays .= '<img title="Платежная система Яндекс.Деньги" width="50" height="30" src="http://img.combatz.ru/pay/e-payment/yandexmoney.png">';  
					  }
					  if( $abnk['qiwi'] != '0' ) {
						$epays .= '<img title="Платежная система и терминалы QIWI" width="50" height="30" src="http://img.combatz.ru/pay/terminal/qiwi.png">';  
					  }
					  if( $abnk['zpayment'] != '0' ) {
						$epays .= '<img title="Платежная система Z-Payment" width="50" height="30" src="http://img.combatz.ru/pay/e-payment/zpayment.png">';  
					  }
					  if( $epays != '' ) { $epays =  '<div align="left" style="height:1px; width:300px; background-color:#999999; margin:3px;"></div><center>'.$epays.'</center>'; }
					  echo $epays;
					  //
					  }else{ ?>
                      <b><font color="red"><small>Алхимик не имеет средств для продажи</small></font></b>
                      <? } ?>
					  </fieldset>
					  <?
				 }
				 ...
				 if($uref>9)
				 {
					 ...
					 if($rico>0)
					 {
						...
						echo '<a href="#'.$uref.'"><img src="http://img.combatz.ru/reg_ico_'.$rico.'.png" onMouseOver="top.hi(this,\'Орден Регатов, '.$stp[$rico].'\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
				 }
				 */
				 ...
				 //сильвер
				 if($st['silver']>0) {
					 $ico[1] .= ' <a href="http://combatz.ru/library/Vip/" target="_blank"><img src="http://img.combatz.ru/i/vip2.gif" onMouseOver="top.hi(this,\'VIP игрок Бойцовского Клуба\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a> ';
				 }
				 
				 //сильвер
				 /*if($st['naemnik']>0) {
				 	echo '<img src="http://img.combatz.ru/naim.gif" onMouseOver="top.hi(this,\'<b>Лицензия наемника</b><br>Участвует в рейтинге наемников\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"> ';
				 }*/
				 
				/*if($inf['activ'] == 0) {
					echo '<img src="http://img.combatz.ru/realpers1.gif" onMouseOver="top.hi(this,\'<b>Реальный игрок</b><br>Уровень подтверждения: Персональные данные\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();">';
				}*/
				 ...
				 {					 
					 ...
					 if($irep['rep1']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/znrune_3.gif" onMouseOver="top.hi(this,\'<b>Храм Знаний</b><br>Посвященный третьего круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['rep1']>999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/znrune_2.gif" onMouseOver="top.hi(this,\'<b>Храм Знаний</b><br>Посвященный второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['rep1']>99)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/znrune_1.gif" onMouseOver="top.hi(this,\'<b>Храм Знаний</b><br>Посвященный первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //Алтарь крови
					 if($irep['rep2']>99)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/znbl_1.gif" onMouseOver="top.hi(this,\'<b>Алтарь Крови</b><br>Посвященный первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //Излом хаоса
					 if($irep['repizlom']>99)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/iz_zn_ver10_1.gif" onMouseOver="top.hi(this,\'<b>Излом Хаоса</b><br>Аттестованный боец\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					
					 //capitalcity
					 if($irep['repcapitalcity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn1_2.gif" onMouseOver="top.hi(this,\'<b>Capital city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repcapitalcity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn1_1.gif" onMouseOver="top.hi(this,\'<b>Capital city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //angelscity
					 if($irep['repangelscity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn2_2.gif" onMouseOver="top.hi(this,\'<b>Angels city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repangelscity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn2_1.gif" onMouseOver="top.hi(this,\'<b>Angels city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //demonscity
					 if($irep['repdemonscity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn3_2.gif" onMouseOver="top.hi(this,\'<b>Demons city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repdemonscity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn3_1.gif" onMouseOver="top.hi(this,\'<b>Demons city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //devilscity
					 if($irep['repdevilscity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn4_2.gif" onMouseOver="top.hi(this,\'<b>Devils city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repdevilscity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn4_1.gif" onMouseOver="top.hi(this,\'<b>Devils city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //suncity
					 if($irep['repsuncity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn5_2.gif" onMouseOver="top.hi(this,\'<b>Suncity</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repsuncity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn5_1.gif" onMouseOver="top.hi(this,\'<b>Suncity</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //emeraldscity
					 if($irep['repemeraldscity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn6_2.gif" onMouseOver="top.hi(this,\'<b>Emeralds city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repemeraldscity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn6_1.gif" onMouseOver="top.hi(this,\'<b>Emeralds city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //sandcity
					 if($irep['repsandcity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn7_2.gif" onMouseOver="top.hi(this,\'<b>Sand city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repsandcity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn7_1.gif" onMouseOver="top.hi(this,\'<b>Sand city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
					 
					 //mooncity
					 if($irep['repmooncity']>24999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn9_2.gif" onMouseOver="top.hi(this,\'<b>Moon city</b><br>Рыцарь второго круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }elseif($irep['repmooncity']>9999)
					 {
						 $ico[1] .= '<a href="#"><img src="http://img.combatz.ru/zn9_1.gif" onMouseOver="top.hi(this,\'<b>Moon city</b><br>Рыцарь первого круга\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();"></a>';
					 }
				 }
				...
				if($inf['jail']>time())
				{
					echo '<br><img src="http://img.combatz.ru/i/jail.gif"> Персонаж находится в заточении еще '.timeOut($inf['jail']-time()).' ';
				}
				if(isset($st['puti']))
				{
					echo '<br><img src="http://img.combatz.ru/i/items/chains.gif"> Персонаж не может передвигаться еще '.timeOut($st['puti']-time()).' ';
				}
				if($inf['molch1']>time())
				{
					echo '<br><img src="http://img.combatz.ru/i/sleeps'.$inf['sex'].'.gif"> На персонажа наложено заклятие молчания. Будет молчать еще '.timeOut($inf['molch1']-time()).' ';
				}
				if($inf['molch2']>time())
				{
					echo '<br><img src="http://img.combatz.ru/i/fsleeps'.$inf['sex'].'.gif"> На персонажа наложено заклятие молчания на форуме. Будет молчать еще '.timeOut($inf['molch2']-time()).' ';
				}
				if($inf['info_delete'] > time() || $inf['info_delete'] == 1)
				{
					echo '<br><img src="http://img.combatz.ru/stopinfo.png"> На персонажа наложено заклятие обезличивания.';
				...
				if($inf['banned'] > 0)
				{
					echo '<br><img src="http://img.combatz.ru/block.png"> На персонажа наложено заклятие смерти.';
					if( $inf['info_delete'] > 1 ) {
				...
				while($pl = mysql_fetch_array($sp))
				{
					...
					echo '<br><img src="http://img.combatz.ru/i/travma2.gif"> У персонажа - &quot;<b>'.$pl['name'].'</b>&quot; еще '.$u->timeOut($pl['timeUse']-time()+$pl['timeAce']);
				}
				...
				if($inf['level']>=4)
				{
					...
					while($nn<count($st['effects']))
					{
						...
						{							
							...
							echo '<br><img src="http://img.combatz.ru/i/travma2.gif"> Персонаж ослаблен из-за смерти в бою, еще '.timeOut($st['effects'][$nn]['timeUse']+$st['effects'][$nn]['timeAce']+$osl['actionTime']-time()).' ';
				...
				if( $igon2 == 3 ) {
					$ico[3] = '<img src="http://img.combatz.ru/bronze11.png" onMouseOver="top.hi(this,\'Третье место в гонке уровней\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();">'.$ico[3];
				}
				if( $igon2 == 2 ) {
					$ico[3] = '<img src="http://img.combatz.ru/silver11.png" onMouseOver="top.hi(this,\'Второе место в гонке уровней\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();">'.$ico[3];
				}
				if( $igon2 == 1 ) {
					$ico[3] = '<img src="http://img.combatz.ru/gold11.png" onMouseOver="top.hi(this,\'Первое место в гонке уровней\',event,0,0,1,0,\'\');" onMouseOut="top.hic();" onMouseDown="top.hic();">'.$ico[3];
				}
...
Подарок от '.$pl['gift'].'" />';
				...
				if($gs[0]!='' || $gs[1]!='' || $gs[2]!=''){
					...
					if(!isset($_GET['maxgift'])){
						echo '<small><a href="inf.php?'.$inf['id'].'&maxgift=1">Нажмите сюда, чтобы увидеть все подарки...</a></small>';
					}else{
						echo '<small><a href="inf.php?'.$inf['id'].'">Нажмите сюда, чтобы скрыть подарки</a></small>';
					}
				}
              ...
              <table style="padding-left:10px;" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    &nbsp; <input value="Обнулить ожидание" type="button" onclick="location.href='inf.php?<?=$inf['id']?>&emonster&restartmonster'" />
                    </td>
                </tr>
                <tr>
...
<div onClick="location.href='inf.php?<?=$inf['id']?>'" style="border:1px solid #999999; cursor:pointer; background-color:#EAEAEA; width:150px;" align="center"><small>Скрыть</small></div>
</div>
<?
					}else{
?>
<div style="height:1px; width:300px; background-color:#999999; margin:3px;" align="center">
<div onClick="location.href='inf.php?<?=$inf['id']?>&emonster'" style="border:1px solid #999999; cursor:pointer; background-color:#EAEAEA; width:150px;" align="center"><small>Настройка монстра</small></div>
</div>
<?
					}
				}
				...
				if($inf['no_ip'] != 'trupojor' && (($u->info['align']>=1.1 && $u->info['align']<=1.99 && $inf['admin']<1) || ($u->info['align']>=3.05 && $u->info['align']<=3.99 && $inf['admin']<1) || $u->info['admin']>0 || $u->info['nadmin']>0)) 
				{
					...
					} elseif ($u->info['admin']==0 && (($u->info['admin']==0 && (floor($u->info['align'])==1 && $inf['align']>=3.01 && $inf['align']<=3.99) || (floor($u->info['align'])==3 && $inf['align']>=1.1 && $inf['align']<=1.99)) || ($u->info['admin']==0 && $inf['admin']>0)))  
					{
						...
						if(!isset($_GET['mod_inf'])) {
							echo '<a href="inf.php?'.$inf['id'].'&mod_inf">Показать личное дело</a>';
						}else{
							...
							echo '<a href="inf.php?'.$inf['id'].'">Скрыть личное дело</a>';
						}
						echo '</small><br>';
						...
						if(($u->info['align']>=1.4 && $u->info['align']<=1.99 && $u->info['align']!=1.6 && $u->info['align']!=1.75 && $inf['admin']<1) || ($u->info['align']>=3.05 && $u->info['align']<=3.99 && $u->info['align']!=3.06 && $inf['admin']<1) || $u->info['admin']>0) 
						{
							...
							if(isset($pr1['id']))
							{
								...
								if(isset($pr['id']))
								{
									$pr['login'] = 'Персонажа пригласили: <b>'.$pr['login'].'</b> ['.$pr['level'].'] <a href="inf.php?'.$pr['id'].'" target="_blank"><img src="http://img.combatz.ru/i/inf_capitalcity.gif" title="Инф. о '.$pr['login'].'"></a><br>';
								}else{
...
function user_browser($agent) {
	preg_match("/(MSIE|Opera|Firefox|Chrome|Version|Opera Mini|Netscape|Konqueror|SeaMonkey|Camino|Minefield|Iceweasel|K-Meleon|Maxthon)(?:\/| )([0-9.]+)/", $agent, $browser_info); // регулярное выражение, которое позволяет отпределить 90% браузеров
        ...
        return $browser.' '.$version; // для всех остальных возвращаем браузер и версию
							...
							if($u->info['admin']>0)
							{
								echo 'Доп. возможности: <small><a href="inf.php?'.$inf['id'].'&wipe&sd4='.$u->info['nextAct'].'">сбросить характеристики</a></small><br>';
							...
							{
								echo '<small><a href="inf.php?'.$inf['id'].'&molchMax&sd4='.$u->info['nextAct'].'">Запретить персонажу отправлять сообщения с молчанкой</a></small><br>';
							}
							...
							echo "<br><textarea cols=60 rows=5>Здравствуйте! Мы очень рады новому персонажу в нашем Мире! \r\n Ваш персонаж: ".$inf['login']."  \r\n Ссылка для активации: http://capitalcity.combatz.ru/buttons.php?active=".$inf['active'].".\r\n\r\nС уважением, Администрация combatz.ru!</textarea><br>";
							}
							echo '</div>';
						}
					}
...
<? if($inf['deviz']!=''){ ?>
Девиз: <code><? echo $inf['deviz']; ?></code><BR>  <? } ?>
<? if($inf['hobby']!=''){ ?>  
Увлечения / хобби:<BR>
<? 
		echo str_replace("\n",'<br>',$inf['hobby']); 

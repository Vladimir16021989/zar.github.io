				...
				if(
					send_mime_mail('Бойцовский Клуб',
						...
						'Успешная регистрация персонажа, подтвердите E-mail',
							...
							'Для активации введите код: ' . md5($u->info['login'].'&[combatz.ru]') . '<br>'.
							'Ссылка для активации: <a target="_blank" href="http://oldbk.org/active.php?code='.md5($u->info['login'].'&[combatz.ru]').'">Активация</a>'.

...
<td class=header><b><a href="clans_inf.php?allclans&sort=exp&page=1">Уровень</a></b></td>
<td class=header width=100><b><a href="clans_inf.php?allclans&sort=persons&page=1">Персонажей</a></b></td>
</tr>
...
<td width="50%">
Знак клана: <img src="http://img.combatz.ru/i/clan/<?=$clan['name_mini']?>.gif"> Склонность: <img src="http://img.combatz.ru/i/align/align<?=$clan['align']?>.gif">
</td>
</tr>
<tr>
...
Место клана в рейтинге: <a href="clans_inf.php?allclans#<?=$clan['reiting']?>"><?=$clan['reiting']?></a>
</td>
</tr>
</table>
<BR>

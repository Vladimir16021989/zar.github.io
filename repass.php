...
define('IP',GetRealIp());
			...
			function send_mail($to,$to_name,$from = 'support@combatz.ru',$name = '<b>Бойцовский Клуб</b> 2',$title,$text) {
				send_mime_mail($name,
					   $from,
					   $to_name,
					   $to,
			...
			if($usr['admin'] == 0 && $usr['banned'] == 0) {
				...
				if(isset($_POST['redate'])) {
					...
					if(isset($lst_psw['id'])) {
						...
						//if(send_mail($urs['mail'],$urs['login'],'support@combatz.ru','БК2 - Support',$title,$txt)) {		
...
<meta name="description" content="Новая бесплатная многопользовательская MMORPG онлайн игра «Легендарный Бойцовский Клуб - БК II». Стань участником легендарного Бойцовского Клуба!"/>
...
<!--/LiveInternet-->
         ...
         <?
            ...
            <? }elseif($step == 2){ ?>
                  <table width="400" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <br>
                  <br>
              <input type="button" onclick="top.location.href='http://combatz.ru/repass.php'" class="btn" value="Вернуться">
      ...
      <div align="center" class="menu">
      	<a href="http://lib.combatz.ru/">Библиотека</a>  &nbsp; 
        <a href="http://lib.combatz.ru/main/39">Законы</a>  &nbsp; 
        <a href="http://lib.combatz.ru/main/30">Соглашение</a>  &nbsp; 
        <a href="http://events.combatz.ru/">Новости</a>  &nbsp; 
        <a href="http://forum.combatz.ru/">Форум</a>  &nbsp; 
        <a href="http://top.combatz.ru/">Рейтинг</a>  &nbsp; 
        <a href="http://combatz.ru/">Заглавная страница</a>  &nbsp; 
        <a href="http://support.combatz.ru/">Поддержка</a> 
      </div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="50" align="center"><span class="testro">&laquo;Бойцовский Клуб&raquo; &nbsp; &nbsp; <?=date('Y')?> &copy; Браузерная онлайн игра</span></td>
  </tr>
</table>
</body>
</html>
